...
<?php
    ...
    $ajouter="" ;
    if(isset($_POST['nom'],$_POST['payer'])){
        $success=payer($_POST['nom'],$_POST['payer']) ;
        if($success!=true){
        ...
        <div class="content">
            ...
            <div class="item content2">
                  <form action="" method="post" id="form1">
                         ...
                         <div>
                            <label for="reste">Montant payer</label>
                            <input type="number" required placeholder="montant payer" name="payer" id="reste">
                         </div>
